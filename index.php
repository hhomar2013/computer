...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/44.png" rel="icon">
  <link href="assets/img/44.png" rel="apple-touch-icon">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <ul>
              <li><i class="bi bi-check-circle"></i> جميع أعطال السوفت وير</li>
              <li><i class="bi bi-check-circle"></i> جميع أعطال الهاردوير</li>
            </ul>
            <!-- <p>
